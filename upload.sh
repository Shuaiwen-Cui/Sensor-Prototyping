...
git add .
git status
git commit -m 'auto update sensor prototyping'
echo '--------commit successfully--------'

# git push -f https://github.com/Shuaiwen-Cui/Sensor-Prototyping.git main
git push -u https://github.com/Shuaiwen-Cui/Sensor-Prototyping.git main
# git remote add origin https://github.com/Shuaiwen-Cui/Sensor-Prototyping.git
