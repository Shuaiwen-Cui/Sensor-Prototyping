...
@REM git push -f https://github.com/Shuaiwen-Cui/Sensor-Prototyping.git main
git push -f https://github.com/Shuaiwen-Cui/Sensor-Prototyping.git main
@REM git remote add origin https://github.com/Shuaiwen-Cui/Sensor-Prototyping.git
